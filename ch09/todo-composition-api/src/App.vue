<template>
  <div class="container">
    <div class="card card-body bg-light">
      <div class="title">:: TodoList Application ::</div>
    </div>
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      state.todoList.push({ id: ts + 2, todo: "일요일 애견 카페", completed: true });
      state.todoList.push({ id: ts + 3, todo: "Vue 원고 집필", completed: true });
    });
